...
| Firebase 실제 백업 | 미구현(선택) | 향후 Firebase 구현 주입 필요 |
| 실행 화면 캡처 | 완료 | `docs/screenshots` |
| APK 제공 | 완료 | `releases/Doodly-v1.0-debug.apk` |
| 2분 요약 영상 | **사용자 업로드 필요** | README TODO URL 교체 |
| 10분 발표 영상 | **사용자 업로드 필요** | README TODO URL 교체 |
...
1. 표지의 작성자, 학번, 과목/분반, 제출일
2. README의 2분 요약 영상 URL
3. README의 10분 상세 발표 영상 URL
4. 필요하면 보고서 PDF 표지 정보 갱신
5. GitHub `main` 브랜치에서 링크와 이미지 최종 확인
